          ...
          >
            ...
            <div
              style={{
                ...
                height: '135px',
                borderRadius: '512px',
                background: `url("https://ui-avatars.com/api/?name=${encodeURIComponent(selectedUser.nombre + ' ' + selectedUser.apellido)}&background=1A4756&color=fff&size=128") lightgray 50% / cover no-repeat`,
